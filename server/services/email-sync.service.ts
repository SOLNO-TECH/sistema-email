...
import ImapReceiverService from "./imap-receiver.service";
...
class EmailSyncService {
    ...
    try {
      ...
      for (const account of accounts) {
        try {
          ...
          const result = await ImapReceiverService.fetchAndStoreEmails(
            account.id,
            account.address,
            syncPassword,
            imapHost
   ...
   */
  static async syncAccount(accountId: number, password?: string) {
    try {
