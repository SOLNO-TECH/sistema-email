...
class EmailRealService {
    ...
    static getTransporter() {
        ...
        if (!user || !password) {
            throw new Error("EMAIL_SMTP_USER y EMAIL_SMTP_PASSWORD deben estar configurados en .env");
        }
    ...
    static async sendEmail(options) {
        try {
            ...
            if (!process.env.EMAIL_SMTP_USER || !process.env.EMAIL_SMTP_PASSWORD) {
                console.warn("⚠️ SMTP no configurado. El correo no se enviará realmente.");
                console.warn("💡 Para configurar email gratis, consulta: EMAIL_SETUP_GUIDE.md");
                console.warn("💡 Opciones gratuitas: Gmail (500/día), SendGrid (100/día), Mailgun (5,000/mes)");
                return {
                    success: false,
     ...
     */
    static async sendFromAccount(accountAddress, to, subject, message) {
...
EmailRealService.transporter = null;
exports.default = EmailRealService;
